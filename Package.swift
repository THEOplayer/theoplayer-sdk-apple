...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "THEOplayerSDK",
      url: "https://cdn.theoplayer.com/build/sdk-apple/11.0.0/THEOplayerSDK.xcframework.zip",
      checksum: "825ddde4dfd24599552e1b0227348ac9a737ca81f632c203f3a496372e2e7812"
    ),
    .binaryTarget(
