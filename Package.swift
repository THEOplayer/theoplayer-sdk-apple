...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.6.1/THEOplayerMillicastIntegration.xcframework.zip",
      checksum: "85f4f134efcac80794ea8dae11d0bf894c5806ea475a13a08bdc4855191b39b0"
    ),
    .binaryTarget(
