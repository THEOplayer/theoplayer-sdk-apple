...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/8.10.0/THEOplayerGoogleCastIntegration.xcframework.zip",
      checksum: "5ea99345c3e542a6ec70063eb9e383baabf914cb7d6d56f5c2104b8cd5c013d6"
    ),
    .binaryTarget(
      name: "THEOplayerSDK",
