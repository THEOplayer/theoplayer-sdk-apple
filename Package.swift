...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.1.0/THEOplayerTHEOliveIntegration.xcframework.zip",
      checksum: "b653a6ae00cba2532c90db17e5e7b4e4aa4513def58bb73f40f126e24b086c97"
    ),
    .binaryTarget(
