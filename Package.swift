...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/10.4.0/THEOplayerTHEOadsIntegration.xcframework.zip",
      checksum: "4063621d72c894498e3b48ba8a44eaf7ab93cf6c674e3b1c91f5a9e717c2ed14"
    ),
  ]
)