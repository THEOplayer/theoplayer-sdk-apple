...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/11.9.1/THEOplayerMillicastIntegration.xcframework.zip",
      checksum: "8fecc6654811d7c96e570fca4d9801822c02fda98d5c5e371bb5c4cfaacfbb0d"
    ),
    .binaryTarget(
