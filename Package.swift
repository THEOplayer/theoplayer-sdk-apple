...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/11.5.0/THEOplayerTHEOadsIntegration.xcframework.zip",
      checksum: "8bf68446b1ff8cd53d622f108bf31c39e4007bb6e43ca0f78ca11f2305093722"
    ),
  ]
)