...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.5.0/THEOplayerTHEOliveIntegration.xcframework.zip",
      checksum: "dd6833ed61d7fa4ea7d7ce3b072f5466db0287aae1f4f0605ba92062ef58980f"
    ),
    .binaryTarget(
