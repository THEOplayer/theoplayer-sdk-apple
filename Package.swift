...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/10.11.1/THEOplayerTHEOadsIntegration.xcframework.zip",
      checksum: "b4aa22147ac9d3ebed2dbda47ab104538a18f3ecb785f1fc4e824f135197f6a8"
    ),
  ]
)