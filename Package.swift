...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/10.4.0-veikkaus.3/THEOplayerMillicastIntegration.xcframework.zip",
      checksum: "18ee57b470193fecd6d0556cfa86d82278c5960d37090b4d67dfd50157c7a2b7"
    ),
    .binaryTarget(
