...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.10.0/THEOplayerGoogleIMAIntegration.xcframework.zip",
      checksum: "429e8c1dad07237e4a97c54a8a24adc4469e76184462d78773f1f0e2e5948bac"
    ),
    .binaryTarget(
