...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/11.5.3/THEOplayerGoogleCastIntegration.xcframework.zip",
      checksum: "58bbaba8d97016349d28300bc876bd59a85daede7e500bf22fe415a63a637bd4"
    ),
    .binaryTarget(
      name: "THEOplayerSDK",
