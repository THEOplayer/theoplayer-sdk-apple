...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.10.1/THEOplayerGoogleCastIntegration.xcframework.zip",
      checksum: "6caa6439c6cce30a71e72383747b211da9f1c00a648164cd91c630175827dcae"
    ),
    .binaryTarget(
      name: "THEOplayerSDK",
