...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/10.2.1/THEOplayerGoogleCastIntegration.xcframework.zip",
      checksum: "2f78626ab7524034a4216dd0d92c188cec2e3d3d1c3c55d1f245446fcb460359"
    ),
    .binaryTarget(
      name: "THEOplayerSDK",
    ...
    .binaryTarget(
      ...
      url: "https://cdn.theoplayer.com/build/sdk-apple/10.2.1/THEOplayerTHEOadsIntegration.xcframework.zip",
      checksum: "d7ca6c7ab0ecd2aa9dfa010d8ece1ea7d75f4b324b9962193d48e66f14386fdf"
    ),
  ]
)