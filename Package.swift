...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "THEOplayerSDK",
      url: "https://cdn.theoplayer.com/build/sdk-apple/9.8.0/THEOplayerSDK.xcframework.zip",
      checksum: "424fc4d1583aeb9451d44e68806154e56b9e714232fd1d766027c8fab39c4117"
    ),
    .binaryTarget(
